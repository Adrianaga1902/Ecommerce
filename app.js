  ...
  const elements = cartArray.map((cart2) => {
    ...
    <div class="product-in-cart">
      ...
      <div class="cart-title">
        ...
        <div>
          <img id="${cart2.nameProduct}" class="btn-rest1" src="./Icon/minus_sign_icon_178734.svg">
          <p>${cart2.amountCart}</p>
          <img id="${cart2.nameProduct}" class="btn-sum1" src="./Icon/plus_sign_icon_178761.svg">
          <img id="${cart2.nameProduct}" class="btn-trash" src="./Icon/trash_bin_icon-icons.com_67981.svg">
        </div>
      </div>
    </div>
    ` 
